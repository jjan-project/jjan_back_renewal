...
public class GeneralExceptionHandler {
    ...
    public ResponseEntity<ResponseMessage> noSuchEmailError(NoSuchEmailException e) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(ResponseMessage.of(ResponseCode.AUTHENTICATION_FAIL));
    }
    ...
    public ResponseEntity<ResponseMessage> fileConversionError(FileUploadException e) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ResponseMessage.of(ResponseCode.REQUEST_FAIL));
    }
